...
def fetch_marathon_data():
    ...
    try:
        ...
        with open("marathons_raw.json", "w", encoding="utf-8") as f:
            json.dump(raw_output, f, ensure_ascii=False, indent=2)
        print(f"✅ marathons_raw.json 저장 완료 ({len(all_results)}개)")
        ...
        with open("marathons_parsed.json", "w", encoding="utf-8") as f:
            json.dump(output, f, ensure_ascii=False, indent=2)
        print(f"✅ marathons_parsed.json 저장 완료")
...
if __name__ == "__main__":
    ...
    if marathons:
        ...
        print("=" * 70)
        print(f"\n저장된 파일:")
        print(f"  1. marathons_raw.json - 원본 API 응답")
        print(f"  2. marathons_parsed.json - 파싱된 데이터")
